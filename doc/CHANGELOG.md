...
* Defect redmine-44378: Ghostscript process is left running when PDF thumbnail generation times out

### Code cleanup/refactoring

* Defect redmine-44438: DateCalculationTest is not run by `rails test`
* Patch redmine-44392: Replace IO.read with File.read

### Database

* Defect redmine-44375: Concurrency problem in project deletion / project marking for deletion

### Documentation

* Patch redmine-44413: Document that Redmine does not start on Ruby 3.3.0

### Email notifications

* Defect redmine-44442: Large blank space before pre blocks in HTML email notifications

### Performance

* Defect redmine-44372: Chrome freezes for several minutes when opening the possible values page of a key/value list custom field with thousands of values
* Defect redmine-44412: Themes with custom icons.svg slow down page rendering
* Feature redmine-44415: Reduce icon rendering time by caching sprite paths
* Patch redmine-44386: Avoid N+1 queries generated by Webhook#setable_projects

### Projects

* Defect redmine-44462: Project list rows show the context menu cursor although no context menu is available

### Security

* Patch redmine-44371: Filter key parameter from logging

### Translations

* Defect redmine-44418: Fix typo in Japanese translation of mail_body_account_information_external

### UI

* Defect redmine-44408: Autocomplete popup appears off-screen when the caret is near the bottom of the viewport
